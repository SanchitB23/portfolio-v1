...
module.exports = {
  siteMetadata : {
    ...
    image :
        '/preview.png', // Path to your image you placed in the 'static' folder
    twitterUsername : '@sanchit1249',
  },
  plugins : [
    "gatsby-plugin-sass", "gatsby-plugin-gatsby-cloud", "gatsby-plugin-image",
    ...
    "gatsby-plugin-sitemap", `gatsby-plugin-offline`, {
      ...
      options : {
        // You can add multiple tracking ids and a pageview event will be fired
        // for all of them.
        trackingIds : [
